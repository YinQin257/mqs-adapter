 ...
 * @since 1.0.5
 */
@Component("RocketmqBatchBroadcastConsumerListener-rocketmq02")
@MessageAdapter(instanceId = "rocketmq02", topicName = "MQS_TEST_TOPIC_BATCH_BROADCAST", isBatch = true, isBroadcast = true)
public class RocketmqBatchBroadcastConsumerListener implements MessageHandler {

    private static final Logger logger = LoggerFactory.getLogger(RocketmqBatchBroadcastConsumerListener.class);
