 ...
 * @since 1.0.0
 */
@Component("RocketmqBatchBroadcastConsumerListener-rocketmq01")
@MessageAdapter(instanceId = "rocketmq01", topicName = "MQS_TEST_TOPIC_BATCH_BROADCAST", isBatch = true, isBroadcast = true)
